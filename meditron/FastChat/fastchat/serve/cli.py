...
class RichChatIO(ChatIO):
    ...
    def __init__(self, multiline: bool = False, mouse: bool = False, debug: bool = False):
    ...
    def stream_output(self, output_stream):
        ...
        self._console.print()
        print(json.dumps(outputs['usage'], indent=2))
        return text
...
def main(args):
    ...
    if args.style == "simple":
        ...
        chatio = RichChatIO(args.multiline, args.mouse, debug=args.debug)
